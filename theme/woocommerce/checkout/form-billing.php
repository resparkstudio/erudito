...
<div class="woocommerce-billing-fields">
	...
	<?php else : ?>
		...
		<h3 class="text-title-m-mobile lg:text-title-m mb-5 lg:mb-8">
	...
	<div class="">
		...
		//move company name field after phone field
		
		$contact_fields = array_slice( $fields, 0, 4 );
		$billing_fields = array_slice( $fields, 4 );
		...
		if ( $key == 'billing_phone' ) {
			echo '<h3 class="text-h6 mt-12 lg:mt-16 mb-6 inline-block w-full">Billing Information</h3>';
		}
