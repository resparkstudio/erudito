				...
				<?php foreach ( $tab['payments'] as $paymentIndex => $payment ) : ?>
					<div class="px-5 lg:px-20 mt-6 flex items-end"
						...
						<?php if ( $payment['prices'] ) : ?>
							<div class="grid grid-cols-1 lg:grid-cols-[repeat(2,25rem)] gap-2">
								<?php foreach ( $payment['prices'] as $price ) : ?>
									<div class="bg-gray rounded-b-lg max-w-[25rem] w-full">
										<div class="">
											<div class="flex items-center gap-2 bg-blue rounded-t-lg py-3 px-6">
										...
										<div class="w-full">
											<?php foreach ( $price['prices_list'] as $list_item ) : ?>
												<?php if ( $list_item['price_per_month'] ) : ?>
													<div
														...
														<?php if ( $list_item['price_per_year'] ) : ?>
															<span class="text-gray5">
																<?php echo esc_html( $list_item['price_per_year'] ) ?>
															</span>
														<?php endif; ?>
													</div>
												<?php endif; ?>
