							...
							<div>
								<div>
									...
									<?php if ( $item['bottom_description'] ) : ?>
										<p class="text-body-m-light mb-10">
								...
								<div class="items-end gap-2 hidden lg:flex">
									<button class="eureka-slider-prev bg-gray rounded-full p-3 cursor-pointer">
									...
									<button class="eureka-slider-next bg-gray rounded-full p-3 cursor-pointer">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
											xmlns="http://www.w3.org/2000/svg">
											<path
