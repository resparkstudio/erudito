	...
	<div class=" pt-12 lg:pt-20 text-black">
		...
		<div class="h-[300vh] flex ">
			...
			<div class="career-svg-mask-2 h-screen w-1/2 top-0 sticky"
				style="mask-image: url('<?php echo $mask_svg_2; ?>'); -webkit-mask-image: url('<?php echo $mask_svg_2; ?>'); mask-size: 100%; -webkit-mask-size: cover; mask-repeat: no-repeat; mask-position: center;">
