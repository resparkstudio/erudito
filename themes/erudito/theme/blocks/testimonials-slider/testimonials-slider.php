...
<div class="bg-gray py-20 px-20 flex justify-between relative">
	<svg class="absolute left-20 -top-0" width="140" height="95" viewBox="0 0 140 95" fill="none"
	...
	<div class="flex items-end gap-2">
		<button class="testimonials-slider-prev bg-white rounded-full p-3 cursor-pointer">
		...
		<button class="testimonials-slider-next bg-white rounded-full p-3 cursor-pointer">
			<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="max-w-[52.9375rem]">
		<div class="swiper testimonials-slider">
			<div class="swiper-wrapper">
				<?php foreach ( $testimonials as $testimonial ) : ?>
					<div class="swiper-slide">
						<div class="flex flex-col">
							<div class="text-title-m font-argent mb-[6.625rem]">
