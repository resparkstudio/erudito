...
if ( ! function_exists( 'erd_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function erd_posted_on() {
...
if ( ! function_exists( 'erd_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'erd_comment_count' ) ) :
	/**
...
if ( ! function_exists( 'erd_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function erd_entry_footer() {
...
if ( ! function_exists( 'erd_comment_avatar' ) ) :
	/**
	 ...
	 */
	function erd_get_user_avatar_markup( $id_or_email = null ) {

		if ( ! isset( $id_or_email ) ) {
			$id_or_email = get_current_user_id();
		}

		return sprintf( '<div class="vcard">%s</div>', get_avatar( $id_or_email, erd_get_avatar_size() ) );
	}
endif;

if ( ! function_exists( 'erd_discussion_avatars_list' ) ) :
	/**
	 * Displays a list of avatars involved in a discussion for a given post.
	 *
	 * @param array $comment_authors Comment authors to list as avatars.
	 */
	function erd_discussion_avatars_list( $comment_authors ) {
		...
		foreach ( $comment_authors as $id_or_email ) {
			printf(
				"<li>%s</li>\n",
				erd_get_user_avatar_markup( $id_or_email ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			);
		}
		echo '</ol>', "\n";
	}
...
if ( ! function_exists( 'erd_the_posts_navigation' ) ) :
	/**
...
if ( ! function_exists( 'erd_content_class' ) ) :
	/**
	 ...
	 * ERD_TYPOGRAPHY_CLASSES constant.)
	 *
	 ...
	 */
	function erd_content_class( $classes = '' ) {
		$all_classes = array( $classes, ERD_TYPOGRAPHY_CLASSES );
