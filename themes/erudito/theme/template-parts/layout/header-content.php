...
<?php endif; ?>
<header id="masthead"
    class="relative flex items-center justify-between border-b w-full <?php echo $header_classes; ?>">
    ...
    <div class="lg:w-full lg:border-l pr-5 lg:pr-0 <?php echo $border_classes; ?>" x-data="{ menuOpen: false }">
        <div
            class="flex items-center justify-between gap-4 lg:hidden <?php echo $text_classes; ?>">
            <a href="#"
                class="erd_button py-2.5 px-5 text-caption-semibold <?php echo $button_before_classes; ?>">
                    ...
                    <button class="cursor-pointer" @click="searchOpen = !searchOpen">
                        <svg x-show="!searchOpen" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="<?php echo $search_icon_color; ?>"
                        ...
                        <svg x-show="searchOpen" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 19L19 5" stroke="<?php echo $search_icon_color; ?>"
                                stroke-miterlimit="10" stroke-linecap="square" />
                            <path d="M19 19L5 5" stroke="<?php echo $search_icon_color; ?>"
                                stroke-miterlimit="10" stroke-linecap="square" />
                        </svg>
                    </button>
                    <?php erd_search(); ?>
